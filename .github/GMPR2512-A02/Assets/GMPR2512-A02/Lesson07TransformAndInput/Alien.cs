    ...
    public class Alien : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if(rando == 1)
            {
                ...
                theProjectile.tag = "AlienProjectile";
        ...
        {
            if (collider.transform.tag.Equals("ShipProjectile") || collider.transform.tag.Equals ("AlienProjectile")) return;
            ...
            leaderScript.transform.position += new Vector3(0, -0.1f, 0);
            }
        }
    }
}