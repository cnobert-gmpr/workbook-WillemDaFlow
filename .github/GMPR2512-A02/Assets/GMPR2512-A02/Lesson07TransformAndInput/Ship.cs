...
namespace GMPR2512.Lesson07TransformAndInput
{
    public class Ship : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            Vector3 translation = (Vector3)moveDirection.normalized * _movementSpeed * Time.deltaTime;
            transform.Translate(translation, Space.World);

            Vector3 currentPos = transform.position;
            currentPos.x = Mathf.Clamp(currentPos.x, _xMin, _xMax);
        ...
        private void FireButtonPressed(InputAction.CallbackContext context)
        {
            ...
            theProjectile.tag = "ShipProjectile";
